...
//menu
import AddRawMaterial from "../pages/Master/RawMaterial/addRawMaterial";
import ManageRaw from "../pages/Master/RawMaterial/manageRawMaterial";
import AddVendors from "../pages/Master/Vendors/addVendors";
import ManageVendors from "../pages/Master/Vendors/manageVendors";
import AddEmployees from "../pages/Master/Employees/addEmployees";
import ManageEmployees from "../pages/Master/Employees/manageEmployees";
...
import CreateChallan from "../pages/PreProduction/CreateChallan";
import ManageChallan from "../pages/PreProduction/ManageChallan";
import ChallanPayment from "../pages/PreProduction/ChallanPayments";

const authProtectedRoutes = [

  { path: "/add-raw-material", component: <AddRawMaterial /> },
  { path: "/manage-raw-material", component: <ManageRaw /> },
  { path: "/add-vendors", component: <AddVendors /> },
  ...
  { path: "/create-challan", component: <CreateChallan /> },
  { path: "/manage-challan", component: <ManageChallan /> },
  { path: "/challan-payment", component: <ChallanPayment /> },
