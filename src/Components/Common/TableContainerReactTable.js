...
const DebouncedInput = ({
  ...
  return (
    <input {...props} value={value} id="search-bar-0" className="form-control border-1 search" onChange={e => setValue(e.target.value)} />
  );
};
      ...
      {isGlobalFilter && <Row className="mb-3">
        <CardBody className="border border-dashed border-end-0 border-start-0">
          <form>
            <Row>
              <Col sm={5}>
                <div className="search-box border-1 me-2 mb-2 d-inline-block col-12">
                  <DebouncedInput
                    value={globalFilter ?? ''}
