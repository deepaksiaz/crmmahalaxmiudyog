                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Sign in to continue to Mahalaxmi Udyog</p>
                                                </div>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} Mahalaxmi Udyog Crafted with <i className="mdi mdi-heart text-danger"></i> by Neeya Enterprises</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
